...
LCD_PutString(40,40,"www.doflye.net",Red,Blue);                  ///前景颜色和背景颜色，可以直接预定义，也可以直接填入16进制数字
LCD_PutString(40,60,"I LOVE MY JOB ",Blue2,Yellow);
LCD_PutString(10,80,"上海浩豚电子科技有限公司",Magenta,Green);
...
PutGB3232(0,200,"我",Blue,Yellow);	//写入32x32汉字
PutGB3232(40,200,"爱",Blue,Red);
PutGB3232(80,200,"单",Blue,Magenta);
PutGB3232(120,200,"片",Blue,Green);
PutGB3232(160,200,"机",Blue,Cyan);	
//	show_photo();
