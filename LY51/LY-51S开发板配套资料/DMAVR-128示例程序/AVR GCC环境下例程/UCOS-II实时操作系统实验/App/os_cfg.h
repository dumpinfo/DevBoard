...
#define OS_MAX_TASKS              7    /* Max. number of tasks in your application, MUST be >= 2       */
...
#define OS_TICKS_PER_SEC        100    /* Set the number of ticks in one second                        */
                                       ...
                                       /* --------------------- TASK STACK SIZE ---------------------- */
#define OS_TASK_TMR_STK_SIZE    224    /* Timer      task stack size (# of OS_STK wide entries)        */
#define OS_TASK_STAT_STK_SIZE   224    /* Statistics task stack size (# of OS_STK wide entries)        */
#define OS_TASK_IDLE_STK_SIZE   224    /* Idle       task stack size (# of OS_STK wide entries)        */
