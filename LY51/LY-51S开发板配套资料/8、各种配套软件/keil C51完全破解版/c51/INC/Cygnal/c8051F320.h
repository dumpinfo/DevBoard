...
;
;
; 	FILE NAME  	: C8051F320.H
; 	TARGET MCUs	: C8051F320, 'F321, 'F322, 'F323
; 	DESCRIPTION	: Register/bit definitions for the C8051F32x product family.
;
; 	REVISION 1.1
;
;---------------------------------------------------------------------------*/
...
sfr P2       = 0xA0;    /* PORT 2                                                   */
sfr SPICFG   = 0xA1;    /* SPI CONFIGURATION                                        */
sfr SPICKR   = 0xA2;    /* SPI CLOCK CONFIGURATION                                  */
sfr SPIDAT   = 0xA3;    /* SPI DATA                                                 */
