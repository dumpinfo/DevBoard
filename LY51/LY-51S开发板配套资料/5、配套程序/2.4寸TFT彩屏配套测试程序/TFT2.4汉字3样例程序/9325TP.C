...
LCD_PutString(0,40,"www.doflye.net",White,Blue);                  ///前景颜色和背景颜色，可以直接预定义，也可以直接填入16进制数字
LCD_PutString(0,60,"I LOVE MY JOB ",Black,Blue);
LCD_PutString(0,80,"上海浩豚电子科技有限公司",Magenta,Blue);
LCD_PutString(0,100,"专业技术支持论坛",Blue2,Blue);
LCD_PutString(0,120,"专业开发板工控板",Red,Blue);
LCD_PutString(0,140,"1234567890",Green,Blue);
LCD_PutString(0,160,"abcdefghijklmnopqistuvwxyz",Cyan,Blue);
LCD_PutString(0,180,"`,./<>';:[]{}\|?)(-=+*&^%$",Yellow,Blue);
PutGB3232(0,200,"我",White,Blue);	//写入32x32汉字
PutGB3232(32,200,"爱",White,Blue);
PutGB3232(64,200,"单",White,Blue);
PutGB3232(96,200,"片",White,Blue);
PutGB3232(128,200,"机",White,Blue);	
LCD_PutString(0,240,"专业开发板工控板",White,Blue);
//	show_photo();
