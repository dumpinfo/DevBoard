...
#define CCOLOR 0xffff //前景色

#define BCOLOR 0x0000 //背景色
...
main()
{
  unsigned char i;
       ...
       //绘制矩形平面
	   Show_RGB(LEFT,LEFT+100,TOP,TOP+140,0xff00);
	   Show_RGB(LEFT+120,LEFT+220,TOP,TOP+140,0x00ff);
	   Show_RGB(LEFT,LEFT+100,TOP+160,TOP+300,0x0ff0);
	   Show_RGB(LEFT+120,LEFT+220,TOP+160,TOP+300,0xf00f);
       //画矩形框
