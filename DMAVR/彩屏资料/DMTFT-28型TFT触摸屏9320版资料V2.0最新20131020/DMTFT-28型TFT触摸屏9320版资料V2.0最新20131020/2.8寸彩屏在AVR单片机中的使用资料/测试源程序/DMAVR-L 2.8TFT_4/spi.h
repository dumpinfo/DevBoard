...
// spiSendByte(uchar data) waits until the SPI interface is ready
// and then sends a single byte over the SPI port.  This command
// does not receive anything.
void spiSendByte(uchar data);

// spiTransferByte(uchar data) waits until the SPI interface is ready
...
// spiTransferWord(uchar data) works just like spiTransferByte but
// operates on a whole word (16-bits of data).
//uint spiTransferWord(u16 data);
