...
#define PEN_CLR	        GPIO_ResetBits(GPIO_TOUCHC, GPIO_Pin_12)   //PEN置低,触碰触摸屏时，ADS7843Penirq引脚由未触摸时的高电平变为低电平
#define PEN_SET	        GPIO_SetBits(GPIO_TOUCHC, GPIO_Pin_12)     //PEN置高
#define PEN             GPIO_ReadInputDataBit(GPIO_TOUCHC,GPIO_Pin_12)    //PC12输入的值

#define TPDO_CLR				GPIO_ResetBits(GPIO_TOUCHC, GPIO_Pin_11)   //TPDO置低
#define TPDO_SET				GPIO_SetBits(GPIO_TOUCHC, GPIO_Pin_11)     //TPDO置高
#define TPDOUT          GPIO_ReadInputDataBit(GPIO_TOUCHC,GPIO_Pin_11)   //PC11输入的值

#define BUSY_CLR				GPIO_ResetBits(GPIO_TOUCHC, GPIO_Pin_10)   //BUSY置低
#define BUSY_SET				GPIO_SetBits(GPIO_TOUCHC, GPIO_Pin_10)     //BUSY置高

#define TPDI_CLR				GPIO_ResetBits(GPIO_TOUCHA, GPIO_Pin_8)    //TPDI置低
#define TPDI_SET				GPIO_SetBits(GPIO_TOUCHA, GPIO_Pin_8)      //TPDI置高

#define TPCS_CLR				GPIO_ResetBits(GPIO_TOUCHC, GPIO_Pin_9)    //TPCS置低
#define TPCS_SET				GPIO_SetBits(GPIO_TOUCHC, GPIO_Pin_9)      //TPCS置高

#define TPCLK_CLR				GPIO_ResetBits(GPIO_TOUCHC, GPIO_Pin_8)    //TPCLK置低
#define TPCLK_SET				GPIO_SetBits(GPIO_TOUCHC, GPIO_Pin_8)      //TPCLK置高
