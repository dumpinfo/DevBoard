	...
	.dbfile E:\DMAVR-~3\ReadBmp\TFT.c
...
_ascii::
	...
	.area data(ram, con, rel)
	.dbfile E:\DMAVR-~3\ReadBmp\TFT.c
	.dbfile F:\PROGRA~1\iccavr\include\ascii8x16.h
	.dbsym e ascii _ascii A[2048:2048]c
_GB2312::
	.blkb 2
	.area idata
	.byte 8,0
	...
	.area data(ram, con, rel)
	.dbfile F:\PROGRA~1\iccavr\include\ascii8x16.h
	.dbfile F:\PROGRA~1\iccavr\include\GB2312.h
	.dbsym e GB2312 _GB2312 A[736:736]c
_color::
	.blkb 2
	.area idata
	.word 63488
...
L2:
	...
	.dbsym r index 16 c
	.dbend
	.dbfunc e LCD_RD_REG16 _LCD_RD_REG16 fi
;             pd -> R10,R11
;          index -> R10
	.even
_LCD_RD_REG16::
...
L5:
	...
	.dbsym r val 16 i
	.dbend
	.dbfunc e LCD_WR_DataP _LCD_WR_DataP fV
;            val -> R16,R17
	.even
_LCD_WR_DataP::
	.dbline -1
...
L8:
	...
	.dbsym r p 10 i
	.dbend
	.dbfunc e DisplayChar _DisplayChar fV
;              p -> R22,R23
;              j -> R20
;              i -> R12
;              b -> R10
...
L17:
	...
	.dbsym r i 12 c
	.dbsym r b 10 c
	.dbsym l char_color 12 i
	.dbsym r postion_y 14 c
	.dbsym r postion_x 12 c
	.dbsym r casc 10 c
	.dbend
	.dbfunc e DisplayGB2312 _DisplayGB2312 fV
;              p -> R22,R23
;              j -> R20
;              i -> R12
;              b -> R10
...
L39:
	...
	adiw R28,4
	xjmp pop_xgsetF00C
	.dbsym l s_color 12 i
	.dbsym r y 22 c
	.dbsym r x 10 c
	.dbsym r s 20 pc
	.dbend
	.dbfunc e GUIback _GUIback fV
;            num -> R20,R21
;     back_color -> R10,R11
	.even
_GUIback::
...
L47:
	...
	xjmp pop_xgset300C
	.dbsym r num 20 i
	.dbsym r back_color 10 i
	.dbend
	.dbfunc e GUIpoint _GUIpoint fV
;    point_color -> y+2
;              y -> R12
;              x -> R10
	.even
...
L52:
	...
	ld R10,y+
	ret
	.dbsym l point_color 2 i
	.dbsym r y 12 c
	.dbsym r x 10 c
	.dbend
	.dbfunc e GUIline _GUIline fV
;           temp -> R14,R15
;             dy -> R20,R21
;             dx -> R20,R21
;             s2 -> y+4
...
L53:
	...
	.dbsym r Dy 12 I
	.dbsym r sub 22 I
	.dbsym l line_color 24 i
	.dbsym r y1 12 c
	.dbsym r x1 10 c
	.dbsym l y0 18 c
	.dbsym l x0 16 c
	.dbend
	.dbfunc e GUIfull _GUIfull fV
;              j -> R10
;              i -> R14
;    full_colour -> y+12
;             y1 -> y+10
...
L70:
	...
	.dbsym r j 10 c
	.dbsym r i 14 c
	.dbsym l full_colour 12 i
	.dbsym l y1 10 c
	.dbsym l x1 8 c
	.dbsym r y0 14 c
	.dbsym r x0 12 c
	.dbend
	.dbfunc e plotC _plotC fV
;      yc_colour -> R22,R23
;             yc -> R14,R15
;             xc -> R12
;              y -> R10
...
L79:
	...
	adiw R28,2
	xjmp pop_xgsetF0FC
	.dbsym r yc_colour 22 i
	.dbsym r yc 14 I
	.dbsym r xc 12 c
	.dbsym r y 10 c
	.dbsym r x 20 c
	.dbend
	.dbfunc e GUIcircle _GUIcircle fV
;              d -> R10,R11
;              y -> R22,R23
;              x -> R20,R21
;  circle_colour -> y+18
...
L80:
	...
	.dbsym r y 22 I
	.dbsym r x 20 I
	.dbsym l circle_colour 18 i
	.dbsym r r 10 c
	.dbsym r yc 12 c
	.dbsym r xc 14 c
	.dbend
	.dbfunc e GUI_sprintf_nu _GUI_sprintf_nu fV
;          color -> y+8
;             nu -> y+6
;              y -> R12,R13
;              x -> R10,R11
...
L86:
	...
	.dbsym r x 10 i
	.dbend
	.dbfunc e GUI_sprintf_chartobit _GUI_sprintf_chartobit fV
;              i -> R20,R21
;          color -> R12,R13
;       bin_data -> y+12
;              y -> R10,R11
...
L87:
	...
	.dbsym r i 20 i
	.dbsym r color 12 i
	.dbsym l bin_data 12 i
	.dbsym r y 10 i
	.dbsym r x 22 i
	.dbend
	.dbfunc e GUI_sprintf_chartohex _GUI_sprintf_chartohex fV
;              i -> <dead>
;          color -> R12,R13
;       hex_data -> R22,R23
;              y -> R10,R11
